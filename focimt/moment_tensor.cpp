        ...
        for (int i = 1; i <= SolutionTypes.Length(); i++) {
          ...
          if (DumpOrder.Length()) {
            ...
            if (Formatted)
              ...
              sprintf(txtb, "%c%s%d%s", Type, FOCIMT_SEP, Channel,
              FOCIMT_SEP);
            OutFile << txtb;
            //}
            ...
            for (int i = 1; i <= DumpOrder.Length(); i++) {
              ...
              if (DumpOrder[i] == 'M') {
                ...
                sprintf(txtb,
                    "%13.5e%s%13.5e%s%13.5e%s%13.5e%s%13.5e%s%13.5e%s",
                    Solution.M[1][1], FOCIMT_SEP2, Solution.M[1][2],
                    FOCIMT_SEP2, Solution.M[1][3], FOCIMT_SEP2,
                    Solution.M[2][2], FOCIMT_SEP2, Solution.M[2][3],
              ...
              if (DumpOrder[i] == 'C') {
                ...
                sprintf(txtb,
                    "%13.5e%s%13.5e%s%13.5e%s%13.5e%s%13.5e%s%13.5e%s",
                    Solution.M[3][3], FOCIMT_SEP2, Solution.M[1][1],
                    FOCIMT_SEP2, Solution.M[2][2], FOCIMT_SEP2,
                    Solution.M[1][3], FOCIMT_SEP2, -Solution.M[2][3],
                    FOCIMT_SEP2, -Solution.M[1][2],
                    FOCIMT_SEP2);
                OutFile << txtb;
              }
              ...
              if (DumpOrder[i] == 'w') {
                ...
                FOCIMT_SEP2, Solution.MAGN, FOCIMT_SEP2);
                OutFile << txtb;
              }
              ...
              if (DumpOrder[i] == 'V') {
                ...
                sprintf(txtb,
                    "%11.3e%s%11.3e%s%11.3e%s%11.3e%s%11.3e%s%11.3e%s",
